...
#define Stamp_PCIE_ALIGNMENT (16)
 ...
 * \param [in] inmem_stamp_state_machine_romHashIndex1 Mapped ROM inmem_stamp_state_machine_romHashIndex1, should be of size (32768 * sizeof(uint64_t)).
 * \param [in] inmem_stamp_state_machine_romHashIndex2 Mapped ROM inmem_stamp_state_machine_romHashIndex2, should be of size (32768 * sizeof(uint64_t)).
...
void Stamp(
	...
	const uint64_t *inmem_stamp_state_machine_romHashIndex1,
	const uint64_t *inmem_stamp_state_machine_romHashIndex2,
...
typedef struct { 
	...
	const uint64_t *inmem_stamp_state_machine_romHashIndex1; /**<  [in] Mapped ROM inmem_stamp_state_machine_romHashIndex1, should be of size (32768 * sizeof(uint64_t)). */
	const uint64_t *inmem_stamp_state_machine_romHashIndex2; /**<  [in] Mapped ROM inmem_stamp_state_machine_romHashIndex2, should be of size (32768 * sizeof(uint64_t)). */
