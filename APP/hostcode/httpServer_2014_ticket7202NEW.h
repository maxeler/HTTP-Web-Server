/**\file */
#ifndef SLIC_DECLARATIONS_httpServer_2014_ticket7202NEW_H
#define SLIC_DECLARATIONS_httpServer_2014_ticket7202NEW_H
#include "MaxSLiCInterface.h"
#ifdef __cplusplus
extern "C" {
#endif /* __cplusplus */

#define httpServer_2014_ticket7202NEW_maxNumberOfSockets (16)
#define httpServer_2014_ticket7202NEW_USE_NETWORK_MANAGER (1)
 ...
 */
void httpServer_2014_ticket7202NEW(
 ...
 */
max_run_t *httpServer_2014_ticket7202NEW_nonblock(
	uint64_t ticks_KernelLMem_Read_CommandAndDataStream,
	uint64_t ticks_KernelLMem_Write_CommandAndDataStream,
	uint64_t inscalar_KernelLMem_Read_CommandAndDataStream_totalBursts,
	uint64_t inscalar_KernelLMem_Read_CommandAndDataStream_wordsPerBurst,
...
} httpServer_2014_ticket7202NEW_actions_t;
 ...
 */
void httpServer_2014_ticket7202NEW_run(
	max_engine_t *engine,
	httpServer_2014_ticket7202NEW_actions_t *interface_actions);
 ...
 */
max_run_t *httpServer_2014_ticket7202NEW_run_nonblock(
	max_engine_t *engine,
	httpServer_2014_ticket7202NEW_actions_t *interface_actions);
 ...
 */
void httpServer_2014_ticket7202NEW_run_group(max_group_t *group, httpServer_2014_ticket7202NEW_actions_t *interface_actions);
 ...
 * \return A handle on the execution status of the actions, or NULL in case of error.
 */
max_run_t *httpServer_2014_ticket7202NEW_run_group_nonblock(max_group_t *group, httpServer_2014_ticket7202NEW_actions_t *interface_actions);
 ...
 */
void httpServer_2014_ticket7202NEW_run_array(max_engarray_t *engarray, httpServer_2014_ticket7202NEW_actions_t *interface_actions[]);
 ...
 * \return A handle on the execution status of the actions, or NULL in case of error.
 */
max_run_t *httpServer_2014_ticket7202NEW_run_array_nonblock(max_engarray_t *engarray, httpServer_2014_ticket7202NEW_actions_t *interface_actions[]);
 ...
 */
max_actions_t* httpServer_2014_ticket7202NEW_convert(max_file_t *maxfile, httpServer_2014_ticket7202NEW_actions_t *interface_actions);

/**
 * \brief Initialise a maxfile.
 */
max_file_t* httpServer_2014_ticket7202NEW_init(void);

/* Error handling functions */
int httpServer_2014_ticket7202NEW_has_errors(void);
const char* httpServer_2014_ticket7202NEW_get_errors(void);
void httpServer_2014_ticket7202NEW_clear_errors(void);
/* Free statically allocated maxfile data */
void httpServer_2014_ticket7202NEW_free(void);
/* These are dummy functions for hardware builds. */
int httpServer_2014_ticket7202NEW_simulator_start(void);
int httpServer_2014_ticket7202NEW_simulator_stop(void);

#ifdef __cplusplus
}
#endif /* __cplusplus */
#endif /* SLIC_DECLARATIONS_httpServer_2014_ticket7202NEW_H */
