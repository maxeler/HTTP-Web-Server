...
NAME="httpServerCPUcode_2014_ticket7202NEW" # name of the CPU code

# DFE IP address
IP1="172.17.0.105"
TAP1_NETMASK="255.255.255.224"

USER=os.environ['USER']
SIM_NAME=USER + "Sim"

MAXFILE="httpServer_2014_ticket7202NEW.max"
DESIGN_NAME="httpServer_2014_ticket7202NEW"
